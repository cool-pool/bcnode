...
//          const opts = {
//            rovers: [],
//            minerKey: "minerkeydfj03fkdf"
//          }
//          const engine = new Engine(logger, opts)
//
//          engine._node._dbGetObject({ hash: "test" }).then((data) => {
//            console.log(data)
//          }).catch((e) => {
//            console.trace(e)
//          })
...
//    }
//
//    //const puppetEngine = main()
//
//          //puppetEngine.node._dbGetObject({ hash: "test" }).then((data) => {
//          //    console.log(data);
//          //}).catch((e) => {
//          //    console.trace(e)
//          //})
//
//        //const node = new Node({ _engine: PersistenceRocksDb })
//        //const PersistenceRocksDb = require('../../persistence').RocksDb;
//        //engine.init().then(() => {
//        //// block.softfail = true
//        // node._dbGetBlockFromBlockHash(block).then((blockBody) => {
